...
class Split(object):  # TODO(epot): Use `class StrEnum(str, Enum)` for Python3
  ...
  * `TEST`: the testing data. This is the data to report metrics on. Typically
  ...
  # Could remove this if all `tfds.Split('custom_split_name')` are migrated
  def __new__(cls, split_name):
    return split_name
